...
function Nav(props: Props) {
  ...
  const anchorItems = [
    ...
    },
    {
      key: '5',
      href: '#awards',
      title: <span className="anchorItem" onClick={() => props.setComp('cv')}>Awards</span>,
    },
    // {
    //   key: '6',
    //   href: '#talks',
  ...
  const items: MenuProps['items'] = [
    ...
    {
      key: '5',
      label: <a href='#awards' onClick={() => props.setComp('cv')}>Awards</a>
    },
    // {
    //   key: '6',
  ...
  return (
    <div id="menu" className="nav">
      <div style={{display: 'flex', alignItems: 'center'}}>
        <img src="/face.svg" style={{width: 25, height: 25}}/>
        <span className="name">Leixian Shen</span>
      </div>
      {screen > 660 ?
        <Anchor
